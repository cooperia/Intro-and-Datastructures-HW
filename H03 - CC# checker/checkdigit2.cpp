...
Comments, Schueller:  Tue Feb  5 14:34:44 PST 2008
    1)  Catches invalid account numbers: 1/1
    2)  Detects valid account numbers: 1/1
    3)  Catches invalid card types: 1/1
    4)  Detects valid card types: 0.5/1
	- failed to detect valid Visa: 4999 9999 9999 9996
    5)  Reads card in the correct format (4 groups of 4 digits): 1/1
    6)  Provides user instruction and user feedback: 1/1
    7)  Has some kind of comment header: 1/1
    8)  Has consistent indenting scheme, neat code: 1/1
...
//SCHUELAW: needs to be char '4' not int 4
  else if(d01 == '4'){
	type = 'v';
}
  else if(identd == 6011){
...
//SCHUELAW: failed to compile, I fixed error in following line, compare to
//original.
	cout << "The credit card number you entered is " <<d01 <<d02 <<d03 <<d04 <<" " <<d05 <<d06 <<d07 <<d08 <<" " <<d09 <<d10 <<d11 <<d12 <<" " <<d13 <<d14 <<d15 <<d16 << ".\n";
